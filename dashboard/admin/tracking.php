...
<head>
    ...
    <title>Admin Tracking - <?php echo APP_NAME; ?></title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="stylesheet" href="../../assets/css/dashboard.css">
    <link rel="stylesheet" href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css"/>
    <style>
        .sidebar { min-height: 100vh; background: linear-gradient(135deg, #0d6efd 0%, #0b5ed7 100%); }
...
<body class="role-admin">
    ...
    async function loadCollectors(){
        ...
        for (const c of json.collectors) {
                ...
                <div class="d-flex justify-content-between align-items-start">
                    <div class="flex-grow-1">
                        <div class="collector-name">
                            <i class="fas fa-truck text-primary me-2"></i>${name}
                        </div>
            ...
            if (lat && lng) {
                ...
                // start a polyline for this collector
                try {
    ...
    (function addToggle(){
        ...
        btn.className = 'btn btn-primary toggle-paths-btn';
