...
<body class="role-collector">
            ...
            <div class="col-md-10">
                <div class="p-4">
                    ...
                    <div class="profile-header">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <?php if ($user['phone']): ?>
                                    <p class="mb-0"><i class="fas fa-phone me-2"></i><?php echo e($user['phone']); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card mb-3">
                                <div class="card-header bg-warning text-dark"><strong><i class="fas fa-user-edit me-2"></i>Contact Information</strong></div>
                                <div class="card-body">
                                    <form method="POST">
                        ...
                        <div class="col-md-6">
                            <div class="card mb-3">
                                <div class="card-header bg-warning text-dark"><strong><i class="fas fa-lock me-2"></i>Change Password</strong></div>
                                <div class="card-body">
                                    <form method="POST">
    ...
    <script>
        ...
        function uploadProfileImage(input) {
            ...
            avatarContainer.innerHTML = '<div class="spinner-border text-dark" role="status"><span class="visually-hidden">Uploading...</span></div>';
