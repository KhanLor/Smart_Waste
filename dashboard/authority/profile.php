...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        if (isset($_POST['update_profile'])) {
            ...
            $stmt = $conn->prepare("UPDATE users SET phone = ?, address = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ? AND role = 'authority'");
            ...
            <div class="col-md-9 col-lg-10">
                <div class="p-4">
                    ...
                    <div class="profile-header">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <span class="badge bg-light text-danger"><i class="fas fa-building me-1"></i>City Authority</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card mb-3">
                                <div class="card-header bg-danger text-white"><strong><i class="fas fa-user-edit me-2"></i>Contact Information</strong></div>
                                <div class="card-body">
                                    <form method="POST">
                                        ...
                                        <button class="btn btn-danger" type="submit"><i class="fas fa-save me-1"></i>Save Changes</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card mb-3">
                                <div class="card-header bg-danger text-white"><strong><i class="fas fa-lock me-2"></i>Change Password</strong></div>
                                <div class="card-body">
                                    <form method="POST">
